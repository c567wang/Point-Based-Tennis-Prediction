...
mean(res)
prop.test(c(sum(atp14.basic.pure.valid>0.5),sum(res)),
          c(length(atp14.basic.pure.valid),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp14.oaf.pure.valid>0.5),sum(res)),
          c(length(atp14.oaf.pure.valid),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- consensus.2(wta14.h2h.binary,wta14.co.binary)
mean(res)
prop.test(c(sum(wta14.basic.pure.valid>0.5),sum(res)),
          c(length(wta14.basic.pure.valid),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(wta14.oaf.pure.valid>0.5),sum(res)),
          c(length(wta14.oaf.pure.valid),length(res)),
          alternative="less",correct=FALSE)$p.value

res <- consensus.2(atp18.h2h.binary,atp18.co.binary)
mean(res)
prop.test(c(sum(atp18.basic.pure.valid>0.5),sum(res)),
          c(length(atp18.basic.pure.valid),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp18.oaf.pure.valid>0.5),sum(res)),
          c(length(atp18.oaf.pure.valid),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- consensus.2(wta18.h2h.binary,wta18.co.binary)
mean(res)
prop.test(c(sum(wta18.basic.pure.valid>0.5),sum(res)),
          c(length(wta18.basic.pure.valid),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(wta18.oaf.pure.valid>0.5),sum(res)),
          c(length(wta18.oaf.pure.valid),length(res)),
          alternative="less",correct=FALSE)$p.value

res <- consensus.2(atp22.h2h.binary,atp22.co.binary)
mean(res)
prop.test(c(sum(atp22.basic.pure.valid>0.5),sum(res)),
          c(length(atp22.basic.pure.valid),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp22.oaf.pure.valid>0.5),sum(res)),
          c(length(atp22.oaf.pure.valid),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- consensus.2(wta22.h2h.binary,wta22.co.binary)
mean(res)
prop.test(c(sum(wta22.basic.pure.valid>0.5),sum(res)),
          c(length(wta22.basic.pure.valid),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(wta22.oaf.pure.valid>0.5),sum(res)),
          c(length(wta22.oaf.pure.valid),length(res)),
          alternative="less",correct=FALSE)$p.value
```
...
merges.2.pure <- function(res1,res2){
  # predict only when all components have results
  ind <- which(res1>=0 & res2>=0)
  n <- length(ind)
  res <- rep(0,n)
  for (i in 1:n){
    res[i] <- mean(c(res1[ind[i]],res2[ind[i]]))
  }
  return(res)
}

merges.3 <- function(res1,res2,res3){
  n <- length(res1)
  res <- rep(0,n)
  for (i in 1:n){
    if (res1[i]==-1){
      res[i] <- merges.2(res2[i],res3[i])
    } else if (res2[i]==-1){
      res[i] <- merges.2(res1[i],res3[i])
    } else if (res3[i]==-1){
      res[i] <- merges.2(res1[i],res2[i])
    } else {
...
merges.3.pure <- function(res1,res2,res3){
  # predict only when all components have results
  ind <- which(res1>=0 & res2>=0 & res3>=0)
  n <- length(ind)
  res <- rep(0,n)
  for (i in 1:n){
    res[i] <- mean(c(res1[ind[i]],res2[ind[i]],res3[ind[i]]))
  }
  return(res)
}

merges.4.pure <- function(res1,res2,res3,res4){
  # predict only when all components have results
  ind <- which(res1>=0 & res2>=0 & res3>=0 & res4 >=0)
  n <- length(ind)
  res <- rep(0,n)
  for (i in 1:n){
    res[i] <- mean(c(res1[ind[i]],res2[ind[i]],res3[ind[i]],res4[ind[i]]))
  }
  return(res)
}

merges.6.pure <- function(res1,res2,res3,res4,res5,res6){
  # predict only when all components have results
  ind <- which(res1>=0 & res2>=0 & res3>=0 & res4 >=0 & res5 >=0 & res6 >=0)
  n <- length(ind)
  res <- rep(0,n)
  for (i in 1:n){
    res[i] <- mean(c(res1[ind[i]],res2[ind[i]],res3[ind[i]],
                     res4[ind[i]],res5[ind[i]],res6[ind[i]]))
  }
  return(res)
}
```
...
```{r}
res <- merges.2.pure(atp14.h2h,atp14.co)
mean(res>0.5)
prop.test(c(sum(atp14.basic>0.5),sum(res>0.5)),
          c(length(atp14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp14.oaf>0.5),sum(res>0.5)),
          c(length(atp14.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta14.h2h,wta14.co)
mean(res>0.5)
prop.test(c(sum(wta14.basic>0.5),sum(res>0.5)),
          c(length(wta14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(wta14.oaf>0.5),sum(res>0.5)),
          c(length(wta14.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value

res <- merges.2.pure(atp18.h2h,atp18.co)
mean(res>0.5)
prop.test(c(sum(atp18.basic>0.5),sum(res>0.5)),
          c(length(atp18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp18.oaf>0.5),sum(res>0.5)),
          c(length(atp18.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta18.h2h,wta18.co)
mean(res>0.5)
prop.test(c(sum(wta18.basic>0.5),sum(res>0.5)),
          c(length(wta18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(wta18.oaf>0.5),sum(res>0.5)),
          c(length(wta18.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value

res <- merges.2.pure(atp22.h2h,atp22.co)
mean(res>0.5)
prop.test(c(sum(atp22.basic>0.5),sum(res>0.5)),
          c(length(atp22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp22.oaf>0.5),sum(res>0.5)),
          c(length(atp22.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta22.h2h,wta22.co)
mean(res>0.5)
prop.test(c(sum(wta22.basic>0.5),sum(res>0.5)),
          c(length(wta22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(wta22.oaf>0.5),sum(res>0.5)),
...
```{r}
res <- merges.2.pure(atp14.ps.up,atp14.ps.down)
mean(res>0.5)
prop.test(c(sum(atp14.basic>0.5),sum(res>0.5)),
          c(length(atp14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp14.oaf>0.5),sum(res>0.5)),
          c(length(atp14.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta14.ps.up,wta14.ps.down)
mean(res>0.5)
prop.test(c(sum(wta14.basic>0.5),sum(res>0.5)),
          c(length(wta14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp18.ps.up,atp18.ps.down)
mean(res>0.5)
prop.test(c(sum(atp18.basic>0.5),sum(res>0.5)),
          c(length(atp18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp18.oaf>0.5),sum(res>0.5)),
          c(length(atp18.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta18.ps.up,wta18.ps.down)
mean(res>0.5)
prop.test(c(sum(wta18.basic>0.5),sum(res>0.5)),
          c(length(wta18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp22.ps.up,atp22.ps.down)
mean(res>0.5)
prop.test(c(sum(atp22.basic>0.5),sum(res>0.5)),
          c(length(atp22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp22.oaf>0.5),sum(res>0.5)),
          c(length(atp22.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta22.ps.up,wta22.ps.down)
mean(res>0.5)
prop.test(c(sum(wta22.basic>0.5),sum(res>0.5)),
          c(length(wta22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
```{r}
res <- merges.2.pure(atp14.ps.up,atp14.co.oaf)
mean(res>0.5)
prop.test(c(sum(atp14.basic>0.5),sum(res>0.5)),
          c(length(atp14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp14.oaf>0.5),sum(res>0.5)),
          c(length(atp14.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta14.ps.up,wta14.co.oaf)
mean(res>0.5)
prop.test(c(sum(wta14.basic>0.5),sum(res>0.5)),
          c(length(wta14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp18.ps.up,atp18.co.oaf)
mean(res>0.5)
prop.test(c(sum(atp18.basic>0.5),sum(res>0.5)),
          c(length(atp18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp18.oaf>0.5),sum(res>0.5)),
          c(length(atp18.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta18.ps.up,wta18.co.oaf)
mean(res>0.5)
prop.test(c(sum(wta18.basic>0.5),sum(res>0.5)),
          c(length(wta18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp22.ps.up,atp22.co.oaf)
mean(res>0.5)
prop.test(c(sum(atp22.basic>0.5),sum(res>0.5)),
          c(length(atp22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp22.oaf>0.5),sum(res>0.5)),
          c(length(atp22.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta22.ps.up,wta22.co.oaf)
mean(res>0.5)
prop.test(c(sum(wta22.basic>0.5),sum(res>0.5)),
          c(length(wta22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
```{r}
res <- merges.2.pure(atp14.h2h,atp14.co.oaf)
mean(res>0.5)
prop.test(c(sum(atp14.basic>0.5),sum(res>0.5)),
          c(length(atp14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp14.oaf>0.5),sum(res>0.5)),
          c(length(atp14.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta14.h2h,wta14.co.oaf)
mean(res>0.5)
prop.test(c(sum(wta14.basic>0.5),sum(res>0.5)),
          c(length(wta14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp18.h2h,atp18.co.oaf)
mean(res>0.5)
prop.test(c(sum(atp18.basic>0.5),sum(res>0.5)),
          c(length(atp18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp18.oaf>0.5),sum(res>0.5)),
          c(length(atp18.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta18.h2h,wta18.co.oaf)
mean(res>0.5)
prop.test(c(sum(wta18.basic>0.5),sum(res>0.5)),
          c(length(wta18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp22.h2h,atp22.co.oaf)
mean(res>0.5)
prop.test(c(sum(atp22.basic>0.5),sum(res>0.5)),
          c(length(atp22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp22.oaf>0.5),sum(res>0.5)),
          c(length(atp22.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta22.h2h,wta22.co.oaf)
mean(res>0.5)
prop.test(c(sum(wta22.basic>0.5),sum(res>0.5)),
          c(length(wta22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
```{r}
res <- merges.2.pure(atp14.co,atp14.co.oaf)
mean(res>0.5)
prop.test(c(sum(atp14.basic>0.5),sum(res>0.5)),
          c(length(atp14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp14.oaf>0.5),sum(res>0.5)),
          c(length(atp14.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta14.co,wta14.co.oaf)
mean(res>0.5)
prop.test(c(sum(wta14.basic>0.5),sum(res>0.5)),
          c(length(wta14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp18.co,atp18.co.oaf)
mean(res>0.5)
prop.test(c(sum(atp18.basic>0.5),sum(res>0.5)),
          c(length(atp18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp18.oaf>0.5),sum(res>0.5)),
          c(length(atp18.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta18.co,wta18.co.oaf)
mean(res>0.5)
prop.test(c(sum(wta18.basic>0.5),sum(res>0.5)),
          c(length(wta18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp22.co,atp22.co.oaf)
mean(res>0.5)
prop.test(c(sum(atp22.basic>0.5),sum(res>0.5)),
          c(length(atp22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp22.oaf>0.5),sum(res>0.5)),
          c(length(atp22.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta22.co,wta22.co.oaf)
mean(res>0.5)
prop.test(c(sum(wta22.basic>0.5),sum(res>0.5)),
          c(length(wta22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
```{r}
res <- merges.2.pure(atp14.oaf,atp14.co.oaf)
mean(res>0.5)
prop.test(c(sum(atp14.basic>0.5),sum(res>0.5)),
          c(length(atp14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp14.oaf>0.5),sum(res>0.5)),
          c(length(atp14.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta14.oaf,wta14.co.oaf)
mean(res>0.5)
prop.test(c(sum(wta14.basic>0.5),sum(res>0.5)),
          c(length(wta14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp18.oaf,atp18.co.oaf)
mean(res>0.5)
prop.test(c(sum(atp18.basic>0.5),sum(res>0.5)),
          c(length(atp18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp18.oaf>0.5),sum(res>0.5)),
          c(length(atp18.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta18.oaf,wta18.co.oaf)
mean(res>0.5)
prop.test(c(sum(wta18.basic>0.5),sum(res>0.5)),
          c(length(wta18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp22.oaf,atp22.co.oaf)
mean(res>0.5)
prop.test(c(sum(atp22.basic>0.5),sum(res>0.5)),
          c(length(atp22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp22.oaf>0.5),sum(res>0.5)),
          c(length(atp22.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta22.oaf,wta22.co.oaf)
mean(res>0.5)
prop.test(c(sum(wta22.basic>0.5),sum(res>0.5)),
          c(length(wta22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
```{r}
res <- merges.2.pure(atp14.h2h,atp14.ps.up)
mean(res>0.5)
prop.test(c(sum(atp14.basic>0.5),sum(res>0.5)),
          c(length(atp14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp14.oaf>0.5),sum(res>0.5)),
          c(length(atp14.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta14.h2h,wta14.ps.up)
mean(res>0.5)
prop.test(c(sum(wta14.basic>0.5),sum(res>0.5)),
          c(length(wta14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp18.h2h,atp18.ps.up)
mean(res>0.5)
prop.test(c(sum(atp18.basic>0.5),sum(res>0.5)),
          c(length(atp18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp18.oaf>0.5),sum(res>0.5)),
          c(length(atp18.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta18.h2h,wta18.ps.up)
mean(res>0.5)
prop.test(c(sum(wta18.basic>0.5),sum(res>0.5)),
          c(length(wta18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp22.h2h,atp22.ps.up)
mean(res>0.5)
prop.test(c(sum(atp22.basic>0.5),sum(res>0.5)),
          c(length(atp22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp22.oaf>0.5),sum(res>0.5)),
          c(length(atp22.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta22.h2h,wta22.ps.up)
mean(res>0.5)
prop.test(c(sum(wta22.basic>0.5),sum(res>0.5)),
          c(length(wta22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
```{r}
res <- merges.2.pure(atp14.h2h,atp14.ps.down)
mean(res>0.5)
prop.test(c(sum(atp14.basic>0.5),sum(res>0.5)),
          c(length(atp14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp14.oaf>0.5),sum(res>0.5)),
          c(length(atp14.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta14.h2h,wta14.ps.down)
mean(res>0.5)
prop.test(c(sum(wta14.basic>0.5),sum(res>0.5)),
          c(length(wta14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp18.h2h,atp18.ps.down)
mean(res>0.5)
prop.test(c(sum(atp18.basic>0.5),sum(res>0.5)),
          c(length(atp18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp18.oaf>0.5),sum(res>0.5)),
          c(length(atp18.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta18.h2h,wta18.ps.down)
mean(res>0.5)
prop.test(c(sum(wta18.basic>0.5),sum(res>0.5)),
          c(length(wta18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp22.h2h,atp22.ps.down)
mean(res>0.5)
prop.test(c(sum(atp22.basic>0.5),sum(res>0.5)),
          c(length(atp22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp22.oaf>0.5),sum(res>0.5)),
          c(length(atp22.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta22.h2h,wta22.ps.down)
mean(res>0.5)
prop.test(c(sum(wta22.basic>0.5),sum(res>0.5)),
          c(length(wta22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
```{r}
res <- merges.2.pure(atp14.co,atp14.oaf)
mean(res>0.5)
prop.test(c(sum(atp14.basic>0.5),sum(res>0.5)),
          c(length(atp14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp14.oaf>0.5),sum(res>0.5)),
          c(length(atp14.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta14.co,wta14.oaf)
mean(res>0.5)
prop.test(c(sum(wta14.basic>0.5),sum(res>0.5)),
          c(length(wta14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp18.co,atp18.oaf)
mean(res>0.5)
prop.test(c(sum(atp18.basic>0.5),sum(res>0.5)),
          c(length(atp18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp18.oaf>0.5),sum(res>0.5)),
          c(length(atp18.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta18.co,wta18.oaf)
mean(res>0.5)
prop.test(c(sum(wta18.basic>0.5),sum(res>0.5)),
          c(length(wta18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp22.co,atp22.oaf)
mean(res>0.5)
prop.test(c(sum(atp22.basic>0.5),sum(res>0.5)),
          c(length(atp22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp22.oaf>0.5),sum(res>0.5)),
          c(length(atp22.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta22.co,wta22.oaf)
mean(res>0.5)
prop.test(c(sum(wta22.basic>0.5),sum(res>0.5)),
          c(length(wta22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
```{r}
res <- merges.2.pure(atp14.co,atp14.ps.up)
mean(res>0.5)
prop.test(c(sum(atp14.basic>0.5),sum(res>0.5)),
          c(length(atp14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp14.oaf>0.5),sum(res>0.5)),
          c(length(atp14.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta14.co,wta14.ps.up)
mean(res>0.5)
prop.test(c(sum(wta14.basic>0.5),sum(res>0.5)),
          c(length(wta14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp18.co,atp18.ps.up)
mean(res>0.5)
prop.test(c(sum(atp18.basic>0.5),sum(res>0.5)),
          c(length(atp18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp18.oaf>0.5),sum(res>0.5)),
          c(length(atp18.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta18.co,wta18.ps.up)
mean(res>0.5)
prop.test(c(sum(wta18.basic>0.5),sum(res>0.5)),
          c(length(wta18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp22.co,atp22.ps.up)
mean(res>0.5)
prop.test(c(sum(atp22.basic>0.5),sum(res>0.5)),
          c(length(atp22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp22.oaf>0.5),sum(res>0.5)),
          c(length(atp22.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta22.co,wta22.ps.up)
mean(res>0.5)
prop.test(c(sum(wta22.basic>0.5),sum(res>0.5)),
          c(length(wta22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
```{r}
res <- merges.2.pure(atp14.h2h,atp14.oaf)
mean(res>0.5)
prop.test(c(sum(atp14.basic>0.5),sum(res>0.5)),
          c(length(atp14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp14.oaf>0.5),sum(res>0.5)),
          c(length(atp14.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta14.h2h,wta14.oaf)
mean(res>0.5)
prop.test(c(sum(wta14.basic>0.5),sum(res>0.5)),
          c(length(wta14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp18.h2h,atp18.oaf)
mean(res>0.5)
prop.test(c(sum(atp18.basic>0.5),sum(res>0.5)),
          c(length(atp18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp18.oaf>0.5),sum(res>0.5)),
          c(length(atp18.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta18.h2h,wta18.oaf)
mean(res>0.5)
prop.test(c(sum(wta18.basic>0.5),sum(res>0.5)),
          c(length(wta18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.2.pure(atp22.h2h,atp22.oaf)
mean(res>0.5)
prop.test(c(sum(atp22.basic>0.5),sum(res>0.5)),
          c(length(atp22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp22.oaf>0.5),sum(res>0.5)),
          c(length(atp22.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.2.pure(wta22.h2h,wta22.oaf)
mean(res>0.5)
prop.test(c(sum(wta22.basic>0.5),sum(res>0.5)),
          c(length(wta22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
```{r}
res <- merges.3.pure(atp14.h2h,atp14.co,atp14.oaf)
mean(res>0.5)
prop.test(c(sum(atp14.basic>0.5),sum(res>0.5)),
          c(length(atp14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp14.oaf>0.5),sum(res>0.5)),
          c(length(atp14.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.3.pure(wta14.h2h,wta14.co,wta14.oaf)
mean(res>0.5)
prop.test(c(sum(wta14.basic>0.5),sum(res>0.5)),
          c(length(wta14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.3.pure(atp18.h2h,atp18.co,atp18.oaf)
mean(res>0.5)
prop.test(c(sum(atp18.basic>0.5),sum(res>0.5)),
          c(length(atp18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp18.oaf>0.5),sum(res>0.5)),
          c(length(atp18.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.3.pure(wta18.h2h,wta18.co,wta18.oaf)
mean(res>0.5)
prop.test(c(sum(wta18.basic>0.5),sum(res>0.5)),
          c(length(wta18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.3.pure(atp22.h2h,atp22.co,atp22.oaf)
mean(res>0.5)
prop.test(c(sum(atp22.basic>0.5),sum(res>0.5)),
          c(length(atp22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp22.oaf>0.5),sum(res>0.5)),
          c(length(atp22.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.3.pure(wta22.h2h,wta22.co,wta22.oaf)
mean(res>0.5)
prop.test(c(sum(wta22.basic>0.5),sum(res>0.5)),
          c(length(wta22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
```{r}
res <- merges.3.pure(atp14.h2h,atp14.ps.up,atp14.co.oaf)
mean(res>0.5)
prop.test(c(sum(atp14.basic>0.5),sum(res>0.5)),
          c(length(atp14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp14.oaf>0.5),sum(res>0.5)),
          c(length(atp14.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.3.pure(wta14.h2h,wta14.ps.up,wta14.co.oaf)
mean(res>0.5)
prop.test(c(sum(wta14.basic>0.5),sum(res>0.5)),
          c(length(wta14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.3.pure(atp18.h2h,atp18.ps.up,atp18.co.oaf)
mean(res>0.5)
prop.test(c(sum(atp18.basic>0.5),sum(res>0.5)),
          c(length(atp18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp18.oaf>0.5),sum(res>0.5)),
          c(length(atp18.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.3.pure(wta18.h2h,wta18.ps.up,wta18.co.oaf)
mean(res>0.5)
prop.test(c(sum(wta18.basic>0.5),sum(res>0.5)),
          c(length(wta18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.3.pure(atp22.h2h,atp22.ps.up,atp22.co.oaf)
mean(res>0.5)
prop.test(c(sum(atp22.basic>0.5),sum(res>0.5)),
          c(length(atp22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp22.oaf>0.5),sum(res>0.5)),
          c(length(atp22.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.3.pure(wta22.h2h,wta22.ps.up,wta22.co.oaf)
mean(res>0.5)
prop.test(c(sum(wta22.basic>0.5),sum(res>0.5)),
          c(length(wta22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
### H2H+CO+OAF+CO(OAF)+PSU+PSD

```{r}
res <- merges.6.pure(atp14.h2h,atp14.ps.up,atp14.co.oaf,
                     atp14.oaf,atp14.ps.down,atp14.co)
mean(res>0.5)
prop.test(c(sum(atp14.basic>0.5),sum(res>0.5)),
          c(length(atp14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp14.oaf>0.5),sum(res>0.5)),
          c(length(atp14.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.6.pure(wta14.h2h,wta14.ps.up,wta14.co.oaf,
                     wta14.oaf,wta14.ps.down,wta14.co)
mean(res>0.5)
prop.test(c(sum(wta14.basic>0.5),sum(res>0.5)),
          c(length(wta14.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.6.pure(atp18.h2h,atp18.ps.up,atp18.co.oaf,
                     atp18.oaf,atp18.ps.down,atp18.co)
mean(res>0.5)
prop.test(c(sum(atp18.basic>0.5),sum(res>0.5)),
          c(length(atp18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp18.oaf>0.5),sum(res>0.5)),
          c(length(atp18.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.6.pure(wta18.h2h,wta18.ps.up,wta18.co.oaf,
                     wta18.oaf,wta18.ps.down,wta18.co)
mean(res>0.5)
prop.test(c(sum(wta18.basic>0.5),sum(res>0.5)),
          c(length(wta18.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
...
res <- merges.6.pure(atp22.h2h,atp22.ps.up,atp22.co.oaf,
                     atp22.oaf,atp22.ps.down,atp22.co)
mean(res>0.5)
prop.test(c(sum(atp22.basic>0.5),sum(res>0.5)),
          c(length(atp22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
prop.test(c(sum(atp22.oaf>0.5),sum(res>0.5)),
          c(length(atp22.oaf),length(res)),
          alternative="less",correct=FALSE)$p.value
res <- merges.6.pure(wta22.h2h,wta22.ps.up,wta22.co.oaf,
                     wta22.oaf,wta22.ps.down,wta22.co)
mean(res>0.5)
prop.test(c(sum(wta22.basic>0.5),sum(res>0.5)),
          c(length(wta22.basic),length(res)),
          alternative="less",correct=FALSE)$p.value
