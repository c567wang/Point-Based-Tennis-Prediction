...
Instead here the training/testing file sources are switched for their 2015-2018 counterparts. The purpose is purely to extract experiment results, so variable names will not be changed. For example atp.test.2018 will actually be 2018 data.

```{r}
source("case_patching.R")
grand.slams <- c("Australian Open","Roland Garros","Wimbledon","US Open")
get.prob.2018 <- function(p1,p2,match,atp=TRUE){
...
ic.atp <- ic.match(atp.test.2018$score)
ic.wta <- ic.match(wta.test.2018$score)
```
```{r}
# training data
atp.train.2017 <- read.csv('../Data Lake/Players/2017_atp_individual.csv')
atp.train.3yrs <- read.csv('../Data Lake/Players/2015-2017_atp_individual.csv')
wta.train.2017 <- read.csv('../Data Lake/Players/2017_wta_individual.csv')
wta.train.3yrs <- read.csv('../Data Lake/Players/2015-2017_wta_individual.csv')
atp.h2h.2017 <- read.csv('../Data Lake/Players/2017_atp_h2h.csv')
atp.h2h.3yrs <- read.csv('../Data Lake/Players/2015-2017_atp_h2h.csv')
atp.co.2017 <- read.csv('../Data Lake/Players/2017_atp_co.csv')
atp.co.3yrs <- read.csv('../Data Lake/Players/2015-2017_atp_co.csv')
wta.h2h.2017 <- read.csv('../Data Lake/Players/2017_wta_h2h.csv')
wta.h2h.3yrs <- read.csv('../Data Lake/Players/2015-2017_wta_h2h.csv')
wta.co.2017 <- read.csv('../Data Lake/Players/2017_wta_co.csv')
wta.co.3yrs <- read.csv('../Data Lake/Players/2015-2017_wta_co.csv')
# for the match specific datasets, they also need ic entries removed
atp.h2h.2017 <- atp.h2h.2017[-ic.atp,]
atp.h2h.3yrs <- atp.h2h.3yrs[-ic.atp,]
atp.co.2017 <- atp.co.2017[-ic.atp,]
atp.co.3yrs <- atp.co.3yrs[-ic.atp,]
wta.h2h.2017 <- wta.h2h.2017[-ic.wta,]
wta.h2h.3yrs <- wta.h2h.3yrs[-ic.wta,]
wta.co.2017 <- wta.co.2017[-ic.wta,]
wta.co.3yrs <- wta.co.3yrs[-ic.wta,]
```
```{r}
# remove incomplete matches for test sets
atp.test.2018 <- atp.test.2018[-ic.atp,]
wta.test.2018 <- wta.test.2018[-ic.wta,]
```


### Baseline ATP (estimating the p1,p2s with observed means)

#### 1 - 2017 Data - No Surface Distinction - General Data

```{r}
# augmentations to training set
# reload set after experiment
atp.train.2017$total_pts_served <- atp.train.2017$grass_pts_served +
  atp.train.2017$clay_pts_served + atp.train.2017$hard_pts_served
atp.train.2017$total_service_pts_won <- atp.train.2017$grass_service_pts_won +
  atp.train.2017$clay_service_pts_won + atp.train.2017$hard_service_pts_won
atp.train.2017$p.estimate <- atp.train.2017$total_service_pts_won / 
  atp.train.2017$total_pts_served
# 2 players found not to have data prior to 2018, resulting in estimates of NaN
# For these the average of the remaining players was plugged in
atp.train.2017$p.estimate[which(is.na(atp.train.2017$p.estimate))] <- 
  mean(atp.train.2017$p.estimate[-which(is.na(atp.train.2017$p.estimate))])
```
```{r}
n <- nrow(atp.test.2018)
res1 <- rep(0,n)
for (i in 1:n){
  winner <- atp.test.2018$winner_name[i]
  loser <- atp.test.2018$loser_name[i]
  winner.idx <- which(atp.train.2017$name==winner)
  loser.idx <- which(atp.train.2017$name==loser)
  if (atp.train.2017$p.estimate[winner.idx]>atp.train.2017$p.estimate[loser.idx]) res1[i]<-1
}
mean(res1)
```
...
#### 2 - 2017 Data - Surface Distinction - General Data

```{r}
# augmentations to training set
# reload set after experiment
atp.train.2017$grass_p <- atp.train.2017$grass_service_pts_won/
  atp.train.2017$grass_pts_served
atp.train.2017$hard_p <- atp.train.2017$hard_service_pts_won/
  atp.train.2017$hard_pts_served
atp.train.2017$clay_p <- atp.train.2017$clay_service_pts_won/
  atp.train.2017$clay_pts_served
# like before, filling in NaNs (slightly more now, since some players did not play that
# surface in 2017) with corresponding averages
atp.train.2017$grass_p[which(is.na(atp.train.2017$grass_p))] <- 
  mean(atp.train.2017$grass_p[-which(is.na(atp.train.2017$grass_p))])
atp.train.2017$hard_p[which(is.na(atp.train.2017$hard_p))] <- 
  mean(atp.train.2017$hard_p[-which(is.na(atp.train.2017$hard_p))])
atp.train.2017$clay_p[which(is.na(atp.train.2017$clay_p))] <- 
  mean(atp.train.2017$clay_p[-which(is.na(atp.train.2017$clay_p))])
```
```{r}
n <- nrow(atp.test.2018)
res2 <- rep(0,n)
for (i in 1:n){
  ...
  winner.idx <- which(atp.train.2017$name==winner)
  loser.idx <- which(atp.train.2017$name==loser)
  if (atp.test.2018$surface[i]=="Grass") {
    res2[i] <- atp.train.2017$grass_p[winner.idx]>atp.train.2017$grass_p[loser.idx]
  } else if (atp.test.2018$surface[i]=="Hard") {
    res2[i] <- atp.train.2017$hard_p[winner.idx]>atp.train.2017$hard_p[loser.idx]
  } else if (atp.test.2018$surface[i]=="Clay") {
    res2[i] <- atp.train.2017$clay_p[winner.idx]>atp.train.2017$clay_p[loser.idx]
  } else {
...
#### 3 - 2015-2017 Data - No Surface Distinction - General Data
...
#### 4 - 2015-2017 Data - Surface Distinction - General Data
...
#### 5 - 2017 Data - No Surface Distinction - General Data

```{r}
# reload dataset after using this block
wta.train.2017$total_pts_served <- wta.train.2017$grass_pts_served +
  wta.train.2017$clay_pts_served + wta.train.2017$hard_pts_served
wta.train.2017$total_service_pts_won <- wta.train.2017$grass_service_pts_won +
  wta.train.2017$clay_service_pts_won + wta.train.2017$hard_service_pts_won
wta.train.2017$p.estimate <- wta.train.2017$total_service_pts_won / 
  wta.train.2017$total_pts_served
wta.train.2017$p.estimate[which(is.na(wta.train.2017$p.estimate))] <- 
  mean(wta.train.2017$p.estimate[-which(is.na(wta.train.2017$p.estimate))])
n <- nrow(wta.test.2018)
res5 <- rep(0,n)
for (i in 1:n){
  winner <- wta.test.2018$winner_name[i]
  loser <- wta.test.2018$loser_name[i]
  winner.idx <- which(wta.train.2017$name==winner)
  loser.idx <- which(wta.train.2017$name==loser)
  if (wta.train.2017$p.estimate[winner.idx]>wta.train.2017$p.estimate[loser.idx]) res5[i]<-1
}
mean(res5)
```

#### 6 - 2017 Data - Surface Distinction - General Data

```{r}
# reload dataset after using this block
wta.train.2017$grass_p <- wta.train.2017$grass_service_pts_won/
  wta.train.2017$grass_pts_served
wta.train.2017$hard_p <- wta.train.2017$hard_service_pts_won/
  wta.train.2017$hard_pts_served
wta.train.2017$clay_p <- wta.train.2017$clay_service_pts_won/
  wta.train.2017$clay_pts_served
wta.train.2017$grass_p[which(is.na(wta.train.2017$grass_p))] <- 
  mean(wta.train.2017$grass_p[-which(is.na(wta.train.2017$grass_p))])
wta.train.2017$hard_p[which(is.na(wta.train.2017$hard_p))] <- 
  mean(wta.train.2017$hard_p[-which(is.na(wta.train.2017$hard_p))])
wta.train.2017$clay_p[which(is.na(wta.train.2017$clay_p))] <- 
  mean(wta.train.2017$clay_p[-which(is.na(wta.train.2017$clay_p))])
n <- nrow(wta.test.2018)
res6 <- rep(0,n)
for (i in 1:n){
  winner <- wta.test.2018$winner_name[i]
  ...
  winner.idx <- which(wta.train.2017$name==winner)
  loser.idx <- which(wta.train.2017$name==loser)
  if (wta.test.2018$surface[i]=="Grass") {
    res6[i] <- wta.train.2017$grass_p[winner.idx]>wta.train.2017$grass_p[loser.idx]
  } else if (wta.test.2018$surface[i]=="Hard") {
    res6[i] <- wta.train.2017$hard_p[winner.idx]>wta.train.2017$hard_p[loser.idx]
  } else if (wta.test.2018$surface[i]=="Clay") {
    res6[i] <- wta.train.2017$clay_p[winner.idx]>wta.train.2017$clay_p[loser.idx]
  } else {
    print("something wrong")
  }
}
...
#### 7 - 2015-2017 Data - No Surface Distinction - General Data
...
#### 8 - 2015-2017 Data - Surface Distinction - General Data
...
#### 9 - 2017 Data - No Surface Distinction - Opponent-Adjusted Formula
...
atp.train.2017$total_pts_received <- atp.train.2017$grass_pts_received +
  atp.train.2017$hard_pts_received + atp.train.2017$clay_pts_received
atp.train.2017$total_receiving_pts_won <- atp.train.2017$grass_receiving_pts_won +
  atp.train.2017$hard_receiving_pts_won + atp.train.2017$clay_receiving_pts_won
atp.train.2017$q.estimate <- atp.train.2017$total_receiving_pts_won /
  atp.train.2017$total_pts_received
atp.train.2017$q.estimate[which(is.na(atp.train.2017$q.estimate))] <- 
  mean(atp.train.2017$q.estimate[-which(is.na(atp.train.2017$q.estimate))])

q.bar <- mean(atp.train.2017$q.estimate)
n <- nrow(atp.test.2018)
res9 <- rep(0,n)
...
for (i in 1:n){
  ...
  winner.idx <- which(atp.train.2017$name==winner)
  loser.idx <- which(atp.train.2017$name==loser)
  winner.adj.p <- atp.train.2017$p.estimate[winner.idx] - 
    (atp.train.2017$q.estimate[loser.idx] - q.bar)
  loser.adj.p <- atp.train.2017$p.estimate[loser.idx] - 
    (atp.train.2017$q.estimate[winner.idx] - q.bar)
  res9[i] <- winner.adj.p > loser.adj.p
  exact.res9[i] <- get.prob.2018(winner.adj.p,loser.adj.p,
                                 atp.test.2018$tourney_name[i],atp=TRUE)
}
mean(res9)
saveRDS(exact.res9,"p_est_exact_probs/atp2018_1y_ns_oaf_exact.rds")
```
A very strong jump in accuracy.

#### 10 - 2017 Data - Surface Distinction - Opponent-Adjusted Formula
...
atp.train.2017$clay_p[which(is.na(atp.train.2017$clay_p))] <- 
  mean(atp.train.2017$clay_p[-which(is.na(atp.train.2017$clay_p))])
# q's
atp.train.2017$grass_q <- atp.train.2017$grass_receiving_pts_won /
  atp.train.2017$grass_pts_received
atp.train.2017$hard_q <- atp.train.2017$hard_receiving_pts_won /
  atp.train.2017$hard_pts_received
atp.train.2017$clay_q <- atp.train.2017$clay_receiving_pts_won /
  atp.train.2017$clay_pts_received
atp.train.2017$grass_q[which(is.na(atp.train.2017$grass_q))] <- 
  mean(atp.train.2017$grass_q[-which(is.na(atp.train.2017$grass_q))])
atp.train.2017$hard_q[which(is.na(atp.train.2017$hard_q))] <- 
  mean(atp.train.2017$hard_q[-which(is.na(atp.train.2017$hard_q))])
atp.train.2017$clay_q[which(is.na(atp.train.2017$clay_q))] <- 
  mean(atp.train.2017$clay_q[-which(is.na(atp.train.2017$clay_q))])
q.bar.grass <- mean(atp.train.2017$grass_q)
q.bar.hard <- mean(atp.train.2017$hard_q)
q.bar.clay <- mean(atp.train.2017$clay_q)
...
for (i in 1:n){
  ...
  winner.idx <- which(atp.train.2017$name==winner)
  loser.idx <- which(atp.train.2017$name==loser)
  surf <- atp.test.2018$surface[i]
  if (surf=="Grass") {
    winner.adj.p <- atp.train.2017$grass_p[winner.idx] - 
      (atp.train.2017$grass_q[loser.idx] - q.bar.grass)
    loser.adj.p <- atp.train.2017$grass_p[loser.idx] - 
      (atp.train.2017$grass_q[winner.idx] - q.bar.grass)
    res10[i] <- winner.adj.p > loser.adj.p
  } else if (surf=="Hard"){
    winner.adj.p <- atp.train.2017$hard_p[winner.idx] - 
      (atp.train.2017$hard_q[loser.idx] - q.bar.hard)
    loser.adj.p <- atp.train.2017$hard_p[loser.idx] - 
      (atp.train.2017$hard_q[winner.idx] - q.bar.hard)
    res10[i] <- winner.adj.p > loser.adj.p
  } else if (surf=="Clay"){
    winner.adj.p <- atp.train.2017$clay_p[winner.idx] - 
      (atp.train.2017$clay_q[loser.idx] - q.bar.clay)
    loser.adj.p <- atp.train.2017$clay_p[loser.idx] - 
      (atp.train.2017$clay_q[winner.idx] - q.bar.clay)
    res10[i] <- winner.adj.p > loser.adj.p
  }
  exact.res10[i] <- get.prob.2018(winner.adj.p,loser.adj.p,
                                  atp.test.2018$tourney_name[i],atp=TRUE)
}
mean(res10)
saveRDS(exact.res10,"p_est_exact_probs/atp2018_1y_s_oaf_exact.rds")
```
...
#### 11 - 2015-2017 Data - No Surface Distinction - Opponent-Adjusted Formula
...
for (i in 1:n){
  ...
  exact.res11[i] <- get.prob.2018(winner.adj.p,loser.adj.p,
                                  atp.test.2018$tourney_name[i],atp=TRUE)
}
mean(res11)
saveRDS(exact.res11,"p_est_exact_probs/atp2018_3y_ns_oaf_exact.rds")
```
...
#### 12 - 2015-2017 Data - Surface Distinction - Opponent-Adjusted Formula
...
for (i in 1:n){
  ...
  exact.res12[i] <- get.prob.2018(winner.adj.p,loser.adj.p,
                                  atp.test.2018$tourney_name[i],atp=TRUE)
}
mean(res12)
saveRDS(exact.res12,"p_est_exact_probs/atp2018_3y_s_oaf_exact.rds")
```
...
#### 13 - 2017 Data - No Surface Distinction - H2H Data With CO Support

```{r}
# make a copy where co augmentation will go
data.13 <- atp.h2h.2017
...
for (i in 1:length(h2h.valid)){
  ...
  exact13.h2h[i] <- get.prob.2018(data.13$w_p[h2h.valid[i]],data.13$l_p[h2h.valid[i]],
                                  atp.test.2018$tourney_name[h2h.valid[i]],atp=TRUE)
}
...
data.13$w_total_pts_served_co <- atp.co.2017$grass_pts_served1 + 
  atp.co.2017$hard_pts_served1 + atp.co.2017$clay_pts_served1
data.13$w_total_service_pts_won_co <- atp.co.2017$grass_service_pts_won1 +
  atp.co.2017$hard_service_pts_won1 + atp.co.2017$clay_service_pts_won1
data.13$w_p_co <- data.13$w_total_service_pts_won_co/data.13$w_total_pts_served_co
data.13$l_total_pts_served_co <- atp.co.2017$grass_pts_served2 + 
  atp.co.2017$hard_pts_served2 + atp.co.2017$clay_pts_served2
data.13$l_total_service_pts_won_co <- atp.co.2017$grass_service_pts_won2 +
  atp.co.2017$hard_service_pts_won2 + atp.co.2017$clay_service_pts_won2
...
for (i in 1:length(co.valid)){
  ...
  exact13.co[i] <- get.prob.2018(data.13$w_p_co[co.valid[i]],data.13$l_p_co[co.valid[i]],
                                 atp.test.2018$tourney_name[co.valid[i]],atp=TRUE)
}
...
res13.h2h.sv <- rep(-1,nrow(atp.test.2018))
res13.h2h.sv[h2h.valid] <- res13.h2h
res13.co.sv <- rep(-1,nrow(atp.test.2018))
res13.co.sv[co.valid] <- res13.co
exact13.h2h.sv <- rep(-1,nrow(atp.test.2018))
exact13.h2h.sv[h2h.valid] <- exact13.h2h
exact13.co.sv <- rep(-1,nrow(atp.test.2018))
exact13.co.sv[co.valid] <- exact13.co
saveRDS(exact13.h2h.sv,"p_est_exact_probs/atp2018_1y_ns_h2h.rds")
saveRDS(exact13.co.sv,"p_est_exact_probs/atp2018_1y_ns_co.rds")
```


#### 14 - 2017 Data - Surface Distinction - H2H Data With CO Support

```{r}
data.14 <- atp.h2h.2017
...
h2h.valid <- rep(0,nrow(atp.test.2018))
# see performance for pure h2h data separated by surface
res14.h2h <- c() # initialize and add elements by res14.h2h <- c(res14.h2h,...)
exact14.h2h <- c()
for (i in 1:nrow(atp.test.2018)){
  if (atp.test.2018$surface[i]=="Grass" && !is.na(data.14$w_g[i])){
    res14.h2h <- c(res14.h2h, data.14$w_g[i] > data.14$l_g[i])
    exact14.h2h <- c(exact14.h2h,
                     get.prob.2018(data.14$w_g[i],data.14$l_g[i],
                                   atp.test.2018$tourney_name[i],atp=TRUE))
    h2h.valid[i] <- 1
  } else if (atp.test.2018$surface[i]=="Hard" && !is.na(data.14$w_h[i])){
    res14.h2h <- c(res14.h2h, data.14$w_h[i] > data.14$l_h[i])
    exact14.h2h <- c(exact14.h2h,
                     get.prob.2018(data.14$w_h[i],data.14$l_h[i],
                                   atp.test.2018$tourney_name[i],atp=TRUE))
    h2h.valid[i] <- 1
  } else if (atp.test.2018$surface[i]=="Clay" && !is.na(data.14$w_c[i])){
    res14.h2h <- c(res14.h2h, data.14$w_c[i] > data.14$l_c[i])
    exact14.h2h <- c(exact14.h2h,
                     get.prob.2018(data.14$w_c[i],data.14$l_c[i],
                                   atp.test.2018$tourney_name[i],atp=TRUE))
    h2h.valid[i] <- 1
  }
}
...
data.14$w_g_co <- atp.co.2017$grass_service_pts_won1/atp.co.2017$grass_pts_served1
data.14$w_h_co <- atp.co.2017$hard_service_pts_won1/atp.co.2017$hard_pts_served1
data.14$w_c_co <- atp.co.2017$clay_service_pts_won1/atp.co.2017$clay_pts_served1
data.14$l_g_co <- atp.co.2017$grass_service_pts_won2/atp.co.2017$grass_pts_served2
data.14$l_h_co <- atp.co.2017$hard_service_pts_won2/atp.co.2017$hard_pts_served2
data.14$l_c_co <- atp.co.2017$clay_service_pts_won2/atp.co.2017$clay_pts_served2
res14.co <- c() # same method as before
exact14.co <- c()
co.valid <- rep(0,nrow(atp.test.2018))
for (i in 1:nrow(atp.test.2018)){
  if (atp.test.2018$surface[i]=="Grass" & 
    ...
    exact14.co <- c(exact14.co,
                    get.prob.2018(data.14$w_g_co[i],data.14$l_g_co[i],
                                  atp.test.2018$tourney_name[i],atp=TRUE))
    co.valid[i] <- 1
  } else if (atp.test.2018$surface[i]=="Hard" &
    ...
    exact14.co <- c(exact14.co,
                    get.prob.2018(data.14$w_h_co[i],data.14$l_h_co[i],
                                  atp.test.2018$tourney_name[i],atp=TRUE))
    co.valid[i] <- 1
  } else if (atp.test.2018$surface[i]=="Clay" & 
    ...
    exact14.co <- c(exact14.co,
                    get.prob.2018(data.14$w_c_co[i],data.14$l_c_co[i],
                                  atp.test.2018$tourney_name[i],atp=TRUE))
    co.valid[i] <- 1
  }
}
...
```{r}
# later added to save results
res14.h2h.sv <- rep(-1,nrow(atp.test.2018))
res14.h2h.sv[h2h.valid] <- res14.h2h
res14.co.sv <- rep(-1,nrow(atp.test.2018))
res14.co.sv[co.valid] <- res14.co
exact14.h2h.sv <- rep(-1,nrow(atp.test.2018))
exact14.h2h.sv[h2h.valid] <- exact14.h2h
exact14.co.sv <- rep(-1,nrow(atp.test.2018))
exact14.co.sv[co.valid] <- exact14.co
saveRDS(exact14.h2h.sv,"p_est_exact_probs/atp2018_1y_s_h2h.rds")
saveRDS(exact14.co.sv,"p_est_exact_probs/atp2018_1y_s_co.rds")
```

#### 15 - 2015-2017 Data - No Surface Distinction - H2H Data With CO Support
...
for (i in 1:length(h2h.valid)){
  ...
  exact15.h2h[i] <- get.prob.2018(data.15$w_p[h2h.valid[i]],data.15$l_p[h2h.valid[i]],
                                  atp.test.2018$tourney_name[h2h.valid[i]],atp=TRUE)
}
mean(res15.h2h)
...
for (i in 1:length(co.valid)){
  ...
  exact15.co[i] <- get.prob.2018(data.15$w_p_co[co.valid[i]],data.15$l_p_co[co.valid[i]],
                                 atp.test.2018$tourney_name[co.valid[i]],atp=TRUE)
}
mean(res15.co)
...
```{r}
# later added to save results
res15.h2h.sv <- rep(-1,nrow(atp.test.2018))
res15.h2h.sv[h2h.valid] <- res15.h2h
res15.co.sv <- rep(-1,nrow(atp.test.2018))
res15.co.sv[co.valid] <- res15.co
exact15.h2h.sv <- rep(-1,nrow(atp.test.2018))
exact15.h2h.sv[h2h.valid] <- exact15.h2h
exact15.co.sv <- rep(-1,nrow(atp.test.2018))
exact15.co.sv[co.valid] <- exact15.co
saveRDS(exact15.h2h.sv,"p_est_exact_probs/atp2018_3y_ns_h2h.rds")
saveRDS(exact15.co.sv,"p_est_exact_probs/atp2018_3y_ns_co.rds")
```

#### 16 - 2015-2017 Data - Surface Distinction - H2H Data With CO Support
...
exact16.h2h <- c()
for (i in 1:nrow(atp.test.2018)){
  if (atp.test.2018$surface[i]=="Grass" && !is.na(data.16$w_g[i])){
    res16.h2h <- c(res16.h2h, data.16$w_g[i] > data.16$l_g[i])
    exact16.h2h <- c(exact16.h2h,
                     get.prob.2018(data.16$w_g[i],data.16$l_g[i],
                                   atp.test.2018$tourney_name[i],atp=TRUE))
    h2h.valid[i] <- 1
  } else if (atp.test.2018$surface[i]=="Hard" && !is.na(data.16$w_h[i])){
    res16.h2h <- c(res16.h2h, data.16$w_h[i] > data.16$l_h[i])
    exact16.h2h <- c(exact16.h2h,
                     get.prob.2018(data.16$w_h[i],data.16$l_h[i],
                                   atp.test.2018$tourney_name[i],atp=TRUE))
    h2h.valid[i] <- 1
  } else if (atp.test.2018$surface[i]=="Clay" && !is.na(data.16$w_c[i])){
    res16.h2h <- c(res16.h2h, data.16$w_c[i] > data.16$l_c[i])
    exact16.h2h <- c(exact16.h2h,
                     get.prob.2018(data.16$w_c[i],data.16$l_c[i],
                                   atp.test.2018$tourney_name[i],atp=TRUE))
    h2h.valid[i] <- 1
  }
}
...
for (i in 1:nrow(atp.test.2018)){
  if (atp.test.2018$surface[i]=="Grass" & 
    ...
    exact16.co <- c(exact16.co,
                    get.prob.2018(data.16$w_g_co[i],data.16$l_g_co[i],
                                  atp.test.2018$tourney_name[i],atp=TRUE))
    co.valid[i] <- 1
  } else if (atp.test.2018$surface[i]=="Hard" &
    ...
    exact16.co <- c(exact16.co,
                    get.prob.2018(data.16$w_h_co[i],data.16$l_h_co[i],
                                  atp.test.2018$tourney_name[i],atp=TRUE))
    co.valid[i] <- 1
  } else if (atp.test.2018$surface[i]=="Clay" & 
    ...
    exact16.co <- c(exact16.co,
                    get.prob.2018(data.16$w_c_co[i],data.16$l_c_co[i],
                                  atp.test.2018$tourney_name[i],atp=TRUE))
    co.valid[i] <- 1
  }
}
...
```{r}
# later added to save results
res16.h2h.sv <- rep(-1,nrow(atp.test.2018))
res16.h2h.sv[h2h.valid] <- res16.h2h
res16.co.sv <- rep(-1,nrow(atp.test.2018))
res16.co.sv[co.valid] <- res16.co
exact16.h2h.sv <- rep(-1,nrow(atp.test.2018))
exact16.h2h.sv[h2h.valid] <- exact16.h2h
exact16.co.sv <- rep(-1,nrow(atp.test.2018))
exact16.co.sv[co.valid] <- exact16.co
saveRDS(exact16.h2h.sv,"p_est_exact_probs/atp2018_3y_s_h2h.rds")
saveRDS(exact16.co.sv,"p_est_exact_probs/atp2018_3y_s_co.rds")
```
...
#### 17 - 2017 Data - No Surface Distinction - Opponent-Adjusted Formula
...
# get q estimates as well
wta.train.2017$total_pts_received <- wta.train.2017$grass_pts_received +
  wta.train.2017$hard_pts_received + wta.train.2017$clay_pts_received
wta.train.2017$total_receiving_pts_won <- wta.train.2017$grass_receiving_pts_won +
  wta.train.2017$hard_receiving_pts_won + wta.train.2017$clay_receiving_pts_won
wta.train.2017$q.estimate <- wta.train.2017$total_receiving_pts_won /
  wta.train.2017$total_pts_received
wta.train.2017$q.estimate[which(is.na(wta.train.2017$q.estimate))] <- 
  mean(wta.train.2017$q.estimate[-which(is.na(wta.train.2017$q.estimate))])

q.bar <- mean(wta.train.2017$q.estimate)
n <- nrow(wta.test.2018)
res17 <- rep(0,n)
...
for (i in 1:n){
  ...
  winner.idx <- which(wta.train.2017$name==winner)
  loser.idx <- which(wta.train.2017$name==loser)
  winner.adj.p <- wta.train.2017$p.estimate[winner.idx] - 
    (wta.train.2017$q.estimate[loser.idx] - q.bar)
  loser.adj.p <- wta.train.2017$p.estimate[loser.idx] - 
    (wta.train.2017$q.estimate[winner.idx] - q.bar)
  res17[i] <- winner.adj.p > loser.adj.p
  exact.res17[i] <- get.prob.2018(winner.adj.p,loser.adj.p,
                                  wta.test.2018$tourney_name[i],atp=FALSE)
}
mean(res17)
saveRDS(exact.res17,"p_est_exact_probs/wta2018_1y_ns_oaf_exact.rds")
```

#### 18 - 2017 Data - Surface Distinction - Opponent-Adjusted Formula
...
wta.train.2017$clay_p[which(is.na(wta.train.2017$clay_p))] <- 
  mean(wta.train.2017$clay_p[-which(is.na(wta.train.2017$clay_p))])
# q's
wta.train.2017$grass_q <- wta.train.2017$grass_receiving_pts_won /
  wta.train.2017$grass_pts_received
wta.train.2017$hard_q <- wta.train.2017$hard_receiving_pts_won /
  wta.train.2017$hard_pts_received
wta.train.2017$clay_q <- wta.train.2017$clay_receiving_pts_won /
  wta.train.2017$clay_pts_received
wta.train.2017$grass_q[which(is.na(wta.train.2017$grass_q))] <- 
  mean(wta.train.2017$grass_q[-which(is.na(wta.train.2017$grass_q))])
wta.train.2017$hard_q[which(is.na(wta.train.2017$hard_q))] <- 
  mean(wta.train.2017$hard_q[-which(is.na(wta.train.2017$hard_q))])
wta.train.2017$clay_q[which(is.na(wta.train.2017$clay_q))] <- 
  mean(wta.train.2017$clay_q[-which(is.na(wta.train.2017$clay_q))])
q.bar.grass <- mean(wta.train.2017$grass_q)
q.bar.hard <- mean(wta.train.2017$hard_q)
q.bar.clay <- mean(wta.train.2017$clay_q)
...
for (i in 1:n){
  ...
  winner.idx <- which(wta.train.2017$name==winner)
  loser.idx <- which(wta.train.2017$name==loser)
  surf <- wta.test.2018$surface[i]
  if (surf=="Grass") {
    winner.adj.p <- wta.train.2017$grass_p[winner.idx] - 
      (wta.train.2017$grass_q[loser.idx] - q.bar.grass)
    loser.adj.p <- wta.train.2017$grass_p[loser.idx] - 
      (wta.train.2017$grass_q[winner.idx] - q.bar.grass)
    res18[i] <- winner.adj.p > loser.adj.p
  } else if (surf=="Hard"){
    winner.adj.p <- wta.train.2017$hard_p[winner.idx] - 
      (wta.train.2017$hard_q[loser.idx] - q.bar.hard)
    loser.adj.p <- wta.train.2017$hard_p[loser.idx] - 
      (wta.train.2017$hard_q[winner.idx] - q.bar.hard)
    res18[i] <- winner.adj.p > loser.adj.p
  } else if (surf=="Clay"){
    winner.adj.p <- wta.train.2017$clay_p[winner.idx] - 
      (wta.train.2017$clay_q[loser.idx] - q.bar.clay)
    loser.adj.p <- wta.train.2017$clay_p[loser.idx] - 
      (wta.train.2017$clay_q[winner.idx] - q.bar.clay)
    res18[i] <- winner.adj.p > loser.adj.p
  }
  exact.res18[i] <- get.prob.2018(winner.adj.p,loser.adj.p,
                                  wta.test.2018$tourney_name[i],atp=FALSE)
}
mean(res18)
saveRDS(exact.res18,"p_est_exact_probs/wta2018_1y_s_oaf_exact.rds")
```

#### 19 - 2015-2017 Data - No Surface Distinction - Opponent-Adjusted Formula
...
for (i in 1:n){
  ...
  exact.res19[i] <- get.prob.2018(winner.adj.p,loser.adj.p,
                                  wta.test.2018$tourney_name[i],atp=FALSE)
}
mean(res19)
saveRDS(exact.res19,"p_est_exact_probs/wta2018_3y_ns_oaf_exact.rds")
```

#### 20 - 2015-2017 Data - Surface Distinction - Opponent-Adjusted Formula
...
for (i in 1:n){
  ...
  exact.res20[i] <- get.prob.2018(winner.adj.p,loser.adj.p,
                                  wta.test.2018$tourney_name[i],atp=FALSE)
}
mean(res20)
saveRDS(exact.res20,"p_est_exact_probs/wta2018_3y_s_oaf_exact.rds")
```

#### 21 - 2017 Data - No Surface Distinction - H2H Data With CO Support

```{r}
# make a copy where co augmentation will go
data.21 <- wta.h2h.2017
# in h2h/co datasets, p1 is always the winner
...
for (i in 1:length(h2h.valid)){
  ...
  exact21.h2h[i] <- get.prob.2018(data.21$w_p[h2h.valid[i]],data.21$l_p[h2h.valid[i]],
                                  wta.test.2018$tourney_name[h2h.valid[i]],atp=FALSE)
}
mean(res21.h2h) # 0.84483

# next see accuracy for all entries where co data is available 
data.21$w_total_pts_served_co <- wta.co.2017$grass_pts_served1 + 
  wta.co.2017$hard_pts_served1 + wta.co.2017$clay_pts_served1
data.21$w_total_service_pts_won_co <- wta.co.2017$grass_service_pts_won1 +
  wta.co.2017$hard_service_pts_won1 + wta.co.2017$clay_service_pts_won1
data.21$w_p_co <- data.21$w_total_service_pts_won_co/data.21$w_total_pts_served_co
data.21$l_total_pts_served_co <- wta.co.2017$grass_pts_served2 + 
  wta.co.2017$hard_pts_served2 + wta.co.2017$clay_pts_served2
data.21$l_total_service_pts_won_co <- wta.co.2017$grass_service_pts_won2 +
  wta.co.2017$hard_service_pts_won2 + wta.co.2017$clay_service_pts_won2
...
for (i in 1:length(co.valid)){
  ...
  exact21.co[i] <- get.prob.2018(data.21$w_p_co[co.valid[i]],data.21$l_p_co[co.valid[i]],
                                 wta.test.2018$tourney_name[co.valid[i]],atp=FALSE)
}
mean(res21.co) # 0.628
...
```{r}
# later added to save results
res21.h2h.sv <- rep(-1,nrow(wta.test.2018))
res21.h2h.sv[h2h.valid] <- res21.h2h
res21.co.sv <- rep(-1,nrow(wta.test.2018))
res21.co.sv[co.valid] <- res21.co
exact21.h2h.sv <- rep(-1,nrow(wta.test.2018))
exact21.h2h.sv[h2h.valid] <- exact21.h2h
exact21.co.sv <- rep(-1,nrow(wta.test.2018))
exact21.co.sv[co.valid] <- exact21.co
saveRDS(exact21.h2h.sv,"p_est_exact_probs/wta2018_1y_ns_h2h.rds")
saveRDS(exact21.co.sv,"p_est_exact_probs/wta2018_1y_ns_co.rds")
```

#### 22 - 2017 Data - Surface Distinction - H2H Data With CO Support

```{r}
data.22 <- wta.h2h.2017
# g for grass_p, h for hard_p, c for clay_p
...
exact22.h2h <- c()
h2h.valid <- rep(0,nrow(wta.test.2018))
for (i in 1:nrow(wta.test.2018)){
  if (wta.test.2018$surface[i]=="Grass" && !is.na(data.22$w_g[i])){
    res22.h2h <- c(res22.h2h, data.22$w_g[i] > data.22$l_g[i])
    exact22.h2h <- c(exact22.h2h,
                     get.prob.2018(data.22$w_g[i],data.22$l_g[i],
                                   wta.test.2018$tourney_name[i],atp=FALSE))
    h2h.valid[i] <- 1
  } else if (wta.test.2018$surface[i]=="Hard" && !is.na(data.22$w_h[i])){
    res22.h2h <- c(res22.h2h, data.22$w_h[i] > data.22$l_h[i])
    exact22.h2h <- c(exact22.h2h,
                     get.prob.2018(data.22$w_h[i],data.22$l_h[i],
                                   wta.test.2018$tourney_name[i],atp=FALSE))
    h2h.valid[i] <- 1
  } else if (wta.test.2018$surface[i]=="Clay" && !is.na(data.22$w_c[i])){
    res22.h2h <- c(res22.h2h, data.22$w_c[i] > data.22$l_c[i])
    exact22.h2h <- c(exact22.h2h,
                     get.prob.2018(data.22$w_c[i],data.22$l_c[i],
                                   wta.test.2018$tourney_name[i],atp=FALSE))
    h2h.valid[i] <- 1
  }
}
...
# see performance for pure co data separated by surface
data.22$w_g_co <- wta.co.2017$grass_service_pts_won1/wta.co.2017$grass_pts_served1
data.22$w_h_co <- wta.co.2017$hard_service_pts_won1/wta.co.2017$hard_pts_served1
data.22$w_c_co <- wta.co.2017$clay_service_pts_won1/wta.co.2017$clay_pts_served1
data.22$l_g_co <- wta.co.2017$grass_service_pts_won2/wta.co.2017$grass_pts_served2
data.22$l_h_co <- wta.co.2017$hard_service_pts_won2/wta.co.2017$hard_pts_served2
data.22$l_c_co <- wta.co.2017$clay_service_pts_won2/wta.co.2017$clay_pts_served2
res22.co <- c() # same method as before
exact22.co <- c()
co.valid <- rep(0,nrow(wta.test.2018))
for (i in 1:nrow(wta.test.2018)){
  if (wta.test.2018$surface[i]=="Grass" & 
    ...
    exact22.co <- c(exact22.co,
                    get.prob.2018(data.22$w_g_co[i],data.22$l_g_co[i],
                                  wta.test.2018$tourney_name[i],atp=FALSE))
    co.valid[i] <- 1
  } else if (wta.test.2018$surface[i]=="Hard" &
    ...
    exact22.co <- c(exact22.co,
                    get.prob.2018(data.22$w_h_co[i],data.22$l_h_co[i],
                                  wta.test.2018$tourney_name[i],atp=FALSE))
    co.valid[i] <- 1
  } else if (wta.test.2018$surface[i]=="Clay" & 
    ...
    exact22.co <- c(exact22.co,
                    get.prob.2018(data.22$w_c_co[i],data.22$l_c_co[i],
                                  wta.test.2018$tourney_name[i],atp=FALSE))
    co.valid[i] <- 1
  }
}
...
```{r}
# later added to save results
res22.h2h.sv <- rep(-1,nrow(wta.test.2018))
res22.h2h.sv[h2h.valid] <- res22.h2h
res22.co.sv <- rep(-1,nrow(wta.test.2018))
res22.co.sv[co.valid] <- res22.co
exact22.h2h.sv <- rep(-1,nrow(wta.test.2018))
exact22.h2h.sv[h2h.valid] <- exact22.h2h
exact22.co.sv <- rep(-1,nrow(wta.test.2018))
exact22.co.sv[co.valid] <- exact22.co
saveRDS(exact22.h2h.sv,"p_est_exact_probs/wta2018_1y_s_h2h.rds")
saveRDS(exact22.co.sv,"p_est_exact_probs/wta2018_1y_s_co.rds")
```

#### 23 - 2015-2017 Data - No Surface Distinction - H2H Data With CO Support
...
for (i in 1:length(h2h.valid)){
  ...
  exact23.h2h[i] <- get.prob.2018(data.23$w_p[h2h.valid[i]],data.23$l_p[h2h.valid[i]],
                                  wta.test.2018$tourney_name[h2h.valid[i]],atp=FALSE)
}
...
for (i in 1:length(co.valid)){
  ...
  exact23.co[i] <- get.prob.2018(data.23$w_p_co[co.valid[i]],data.23$l_p_co[co.valid[i]],
                                 wta.test.2018$tourney_name[co.valid[i]],atp=FALSE)
}
mean(res23.co) # 0.606
...
```{r}
# later added to save results
res23.h2h.sv <- rep(-1,nrow(wta.test.2018))
res23.h2h.sv[h2h.valid] <- res23.h2h
res23.co.sv <- rep(-1,nrow(wta.test.2018))
res23.co.sv[co.valid] <- res23.co
exact23.h2h.sv <- rep(-1,nrow(wta.test.2018))
exact23.h2h.sv[h2h.valid] <- exact23.h2h
exact23.co.sv <- rep(-1,nrow(wta.test.2018))
exact23.co.sv[co.valid] <- exact23.co
saveRDS(exact23.h2h.sv,"p_est_exact_probs/wta2018_3y_ns_h2h.rds")
saveRDS(exact23.co.sv,"p_est_exact_probs/wta2018_3y_ns_co.rds")
```

#### 24 - 2015-2017 Data - Surface Distinction - H2H Data With CO Support
...
h2h.valid <- rep(0,nrow(wta.test.2018))
for (i in 1:nrow(wta.test.2018)){
  if (wta.test.2018$surface[i]=="Grass" && !is.na(data.24$w_g[i])){
    res24.h2h <- c(res24.h2h, data.24$w_g[i] > data.24$l_g[i])
    exact24.h2h <- c(exact24.h2h,
                     get.prob.2018(data.24$w_g[i],data.24$l_g[i],
                                   wta.test.2018$tourney_name[i],atp=FALSE))
    h2h.valid[i] <- 1
  } else if (wta.test.2018$surface[i]=="Hard" && !is.na(data.24$w_h[i])){
    res24.h2h <- c(res24.h2h, data.24$w_h[i] > data.24$l_h[i])
    exact24.h2h <- c(exact24.h2h,
                     get.prob.2018(data.24$w_h[i],data.24$l_h[i],
                                   wta.test.2018$tourney_name[i],atp=FALSE))
    h2h.valid[i] <- 1
  } else if (wta.test.2018$surface[i]=="Clay" && !is.na(data.24$w_c[i])){
    res24.h2h <- c(res24.h2h, data.24$w_c[i] > data.24$l_c[i])
    exact24.h2h <- c(exact24.h2h,
                     get.prob.2018(data.24$w_c[i],data.24$l_c[i],
                                   wta.test.2018$tourney_name[i],atp=FALSE))
    h2h.valid[i] <- 1
  }
}
...
for (i in 1:nrow(wta.test.2018)){
  if (wta.test.2018$surface[i]=="Grass" & 
    ...
    exact24.co <- c(exact24.co,
                    get.prob.2018(data.24$w_g_co[i],data.24$l_g_co[i],
                                  wta.test.2018$tourney_name[i],atp=FALSE))
    co.valid[i] <- 1
  } else if (wta.test.2018$surface[i]=="Hard" &
    ...
    exact24.co <- c(exact24.co,
                    get.prob.2018(data.24$w_h_co[i],data.24$l_h_co[i],
                                  wta.test.2018$tourney_name[i],atp=FALSE))
    co.valid[i] <- 1
  } else if (wta.test.2018$surface[i]=="Clay" & 
    ...
    exact24.co <- c(exact24.co,
                    get.prob.2018(data.24$w_c_co[i],data.24$l_c_co[i],
                                  wta.test.2018$tourney_name[i],atp=FALSE))
    co.valid[i] <- 1
  }
}
...
```{r}
# later added to save results
res24.h2h.sv <- rep(-1,nrow(wta.test.2018))
res24.h2h.sv[h2h.valid] <- res24.h2h
res24.co.sv <- rep(-1,nrow(wta.test.2018))
res24.co.sv[co.valid] <- res24.co
exact24.h2h.sv <- rep(-1,nrow(wta.test.2018))
exact24.h2h.sv[h2h.valid] <- exact24.h2h
exact24.co.sv <- rep(-1,nrow(wta.test.2018))
exact24.co.sv[co.valid] <- exact24.co
saveRDS(exact24.h2h.sv,"p_est_exact_probs/wta2018_3y_s_h2h.rds")
saveRDS(exact24.co.sv,"p_est_exact_probs/wta2018_3y_s_co.rds")
```
...
saveRDS(res1,file="res18atp_1yr_g_ns.rds")
saveRDS(res2,file="res18atp_1yr_g_s.rds")
saveRDS(res3,file="res18atp_3yr_g_ns.rds")
saveRDS(res4,file="res18atp_3yr_g_s.rds")
saveRDS(res5,file="res18wta_1yr_g_ns.rds")
saveRDS(res6,file="res18wta_1yr_g_s.rds")
saveRDS(res7,file="res18wta_3yr_g_ns.rds")
saveRDS(res8,file="res18wta_3yr_g_s.rds")
saveRDS(res9,file="res18atp_1yr_oaf_ns.rds")
saveRDS(res10,file="res18atp_1yr_oaf_s.rds")
saveRDS(res11,file="res18atp_3yr_oaf_ns.rds")
saveRDS(res12,file="res18atp_3yr_oaf_s.rds")
saveRDS(res17,file="res18wta_1yr_oaf_ns.rds")
saveRDS(res18,file="res18wta_1yr_oaf_s.rds")
saveRDS(res19,file="res18wta_3yr_oaf_ns.rds")
saveRDS(res20,file="res18wta_3yr_oaf_s.rds")
saveRDS(res13.h2h.sv,file="res18atp_1yr_h2h_ns.rds")
saveRDS(res13.co.sv,file="res18atp_1yr_co_ns.rds")
saveRDS(res14.h2h.sv,file="res18atp_1yr_h2h_s.rds")
saveRDS(res14.co.sv,file="res18atp_1yr_co_s.rds")
saveRDS(res15.h2h.sv,file="res18atp_3yr_h2h_ns.rds")
saveRDS(res15.co.sv,file="res18atp_3yr_co_ns.rds")
saveRDS(res16.h2h.sv,file="res18atp_3yr_h2h_s.rds")
saveRDS(res16.co.sv,file="res18atp_3yr_co_s.rds")
saveRDS(res21.h2h.sv,file="res18wta_1yr_h2h_ns.rds")
saveRDS(res21.co.sv,file="res18wta_1yr_co_ns.rds")
saveRDS(res22.h2h.sv,file="res18wta_1yr_h2h_s.rds")
saveRDS(res22.co.sv,file="res18wta_1yr_co_s.rds")
saveRDS(res23.h2h.sv,file="res18wta_3yr_h2h_ns.rds")
saveRDS(res23.co.sv,file="res18wta_3yr_co_ns.rds")
saveRDS(res24.h2h.sv,file="res18wta_3yr_h2h_s.rds")
saveRDS(res24.co.sv,file="res18wta_3yr_co_s.rds")
```